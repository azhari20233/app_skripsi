	                    ...
	                    <div class="card">
	                        <div class="card-body">
	                            ...
	                            <div class="row">
	                            	<div class="table-responsive">
							            <table class="table table-invoice">
							                ...
							                <tbody>
							                    ...
							                    <tr>
							                        <td>
							                            Gaji Pokok <i class="ti ti-plus"> Tunjangan <i class="ti ti-minus"></i> Potongan <br >(1 hari tanpa keterangan = Rp. 150.000)<br />
							                        </td>
							                        <td></td>
							                        <td></td>
							                        ...
							                        <td align="right"><?php echo 'Rp.'.number_format($row['gaji_bersih'] - $row['potongan']); ?></td>
							                    </tr>
							                </tbody>
							            </table>
							        </div>
		                            ...
		                            <a title="Cetak Data" href="../laporan/gaji_id.php?id_gaji=<?php echo $row['id_gaji']; ?>" class="btn btn-info" target="_blank"><i class="mdi ti-check-box"></i></a>
	                            <?php } ?>
	                        </div>
	                    </div>
	                </div>
