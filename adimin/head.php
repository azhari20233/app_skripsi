      ...
      <div class="modal-content">
        ...
        <div class="col-sm-12" style="margin-bottom: 10px;">
          <select style="color: black;" name="tahun-cetak" class="form-control">
            ...
            <?php if (mysqli_num_rows($qrytahun)) { ?>
              <?php while ($row = mysqli_fetch_array($qrytahun)) { ?>
                <option><?php $formatwaktu = $row["tgl_masuk"];
                        echo date('Y', strtotime($formatwaktu)); ?></option>
              <?php } ?>
            <?php } ?>
          </select>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="col-sm-12" style="margin-bottom: 10px;">
          <select style="color: black;" name="tahun-cetak" class="form-control">
            ...
            <?php if (mysqli_num_rows($qrytahun)) { ?>
              <?php while ($row = mysqli_fetch_array($qrytahun)) { ?>
                <option><?php $formatwaktu = $row["tgl_berangkat"];
                        echo date('Y', strtotime($formatwaktu)); ?></option>
              <?php } ?>
            <?php } ?>
          </select>
      ...
      <div class="modal-content">
        ...
        <div class="col-sm-12" style="margin-bottom: 10px;">
          <select style="color: black;" name="tahun-cetak" class="form-control">
            ...
            <?php if (mysqli_num_rows($qrytahun)) { ?>
              <?php while ($row = mysqli_fetch_array($qrytahun)) { ?>
                <option><?php $formatwaktu = $row["tgl_spt"];
                        echo date('Y', strtotime($formatwaktu)); ?></option>
              <?php } ?>
            <?php } ?>
          </select>
      ...
      <div class="modal-content">
        ...
        <div class="col-sm-12" style="margin-bottom: 10px;">
          <select style="color: black;" name="tahun-cetak" class="form-control">
            ...
            <?php if (mysqli_num_rows($qrytahun)) { ?>
              <?php while ($row = mysqli_fetch_array($qrytahun)) { ?>
                <option><?php $formatwaktu = $row["tgl_sk"];
                        echo date('Y', strtotime($formatwaktu)); ?></option>
              <?php } ?>
            <?php } ?>
          </select>
      ...
      <div class="modal-content">
        ...
        <div class="col-sm-12" style="margin-bottom: 10px;">
          <select style="color: black;" name="tahun-cetak" class="form-control">
            ...
            <?php if (mysqli_num_rows($qrytahun)) { ?>
              <?php while ($row = mysqli_fetch_array($qrytahun)) { ?>
                <option><?php $formatwaktu = $row["tgl_kegiatan"];
                        echo date('Y', strtotime($formatwaktu)); ?></option>
              <?php } ?>
            <?php } ?>
          </select>
      ...
      <div class="modal-content">
        ...
        <div class="col-sm-12" style="margin-bottom: 10px;">
          <select style="color: black;" name="tahun-cetak" class="form-control">
            ...
            <?php if (mysqli_num_rows($qrytahun)) { ?>
              <?php while ($row = mysqli_fetch_array($qrytahun)) { ?>
                <option><?php $formatwaktu = $row["tgl_akhir"];
                        echo date('Y', strtotime($formatwaktu)); ?></option>
              <?php } ?>
            <?php } ?>
          </select>
      ...
      <div class="modal-content">
        ...
        <div class="col-sm-12" style="margin-bottom: 10px;">
          <select style="color: black;" name="tahun-cetak" class="form-control">
            ...
            <?php if (mysqli_num_rows($qrytahun)) { ?>
              <?php while ($row = mysqli_fetch_array($qrytahun)) { ?>
                <option><?php $formatwaktu = $row["tgl_aw"];
                        echo date('Y', strtotime($formatwaktu)); ?></option>
              <?php } ?>
            <?php } ?>
          </select>
