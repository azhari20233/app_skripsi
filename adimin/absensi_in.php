                          ...
                          <div class="row">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-6">
                                 <div class="form-group">
                                    <label for="example-search-input" class="col-form-label">Tgl Saat Sakit (Tanggalnya Saja)</label>
                                    <input class="form-control" name="tgl_sakit" type="text" value="-">
                                </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <label for="example-search-input" class="col-form-label">Tgl Saat Ijin (Tanggalnya Saja)</label>
                                    <input class="form-control" name="tgl_ijin" type="text" value="-">
                                </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <label for="example-search-input" class="col-form-label">Tgl Saat Tanpa Keterangan (Tanggalnya Saja)</label>
                                    <input class="form-control" name="tgl_tk" type="text" value="-">
                                </div>
                              </div>
                            </div>
...
if (isset($_POST['input'])) {
    ...
    $tambah = mysqli_query($koneksi,"INSERT INTO absensi ( tgl,  bulan, tahun,  id_pg,  hadir,  sakit, izin,tanpa_ket,tgl_sakit,tgl_ijin,tgl_tk) VALUES(
          '$now',
          '$bulan',
          '$tahun',
          '$id_pg',
