                          ...
                          <div class="row">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-6">
                                 <div class="form-group">
                                    <label for="example-search-input" class="col-form-label">Tgl Saat Sakit</label>
                                    <input class="form-control" name="tgl_sakit" type="text" value="<?=$row['tgl_sakit']?>">
                                </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <label for="example-search-input" class="col-form-label">Tgl Saat Ijin</label>
                                    <input class="form-control" name="tgl_ijin" type="text" value="<?=$row['tgl_ijin']?>">
                                </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <label for="example-search-input" class="col-form-label">Tgl Saat Tanpa Keterangan</label>
                                    <input class="form-control" name="tgl_tk" type="text" value="<?=$row['tgl_tk']?>">
                                </div>
...
if (isset($_POST['edit'])) {
    ...
    $tambah = mysqli_query($koneksi,"UPDATE absensi SET tgl = '$now', bulan = '$bulan', tahun = '$tahun', id_pg = '$id_pg', hadir = '$hadir',sakit = '$sakit',izin = '$izin', tanpa_ket = '$tanpa_ket' , tgl_sakit = '$tgl_sakit', tgl_ijin = '$tgl_ijin', tgl_tk = '$tgl_tk' WHERE id_absensi = '$id_absensi'");
if($tambah){
