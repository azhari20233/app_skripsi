	                        ...
	                        <div class="card-body">
                              ...
                              <?php }?>
	                            <div class="row">
	                            	...
	                            	<div class="col-6">
	                            		 <div class="form-group">
			                                <label for="example-email-input" class="col-form-label">Golongan</label>
			                                <input readonly="" class="form-control" type="email" value="<?=$row['golongan']?>">
			                            </div>
	                            	</div>
	                            	<div class="col-6">
	                            		 <div class="form-group">
			                                <label for="example-email-input" class="col-form-label">Pegawai</label>
			                                <input readonly="" class="form-control" type="text" value="<?= strtoupper($row['pegawai'])?>">
			                            </div>
	                            	</div>
	                            	<div class="col-6">
	                            		 <div class="form-group">
