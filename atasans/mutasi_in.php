...
if (isset($_POST['input'])) {
  ...
  $new_jabatan = $_POST['new_jabatan'];
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
      ...
      $query = mysqli_query($koneksi, "INSERT INTO mutasi (tgl_m,id_pg,no_sk,tgl_sk,tujuan,new_jabatan,file_p,status_mutasi) VALUES(
                    '$now',
                    '$id_pg',     
                    '$no_sk',
                    '$tgl_sk',                    
    ...
    if($query){
        ...
        ?> <script>alert('Gagal, Ukuran File Maksimal 2MB!'); window.location = 'mutasi_in.php';</script><?php
        }
      }else{
