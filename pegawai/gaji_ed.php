                          ...
                          <div class="row">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                              <div class="col-3">
                                <div class="form-group">
                                    <label for="example-text-input" class="col-form-label">Bonus</label>
                                    <input class="form-control" name="bonus" type="number" value="<?=$row['bonus']?>">
                                </div>
                              </div>
                              <div class="col-3">
                                <div class="form-group">
...
if (isset($_POST['edit'])) {
    ...
    $tambah = mysqli_query($koneksi,"UPDATE gaji SET tgl_gaji = '$now', no_slip = '$no_slip', bulan = '$bulan', tahun = '$tahun', id_absensi = '$id_absensi',gaji_bersih = '$new',bonus = '$bonus', potongan = '$newe' WHERE id_gaji = '$id_gaji'");
if($tambah){
