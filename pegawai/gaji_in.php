                            ...
                            <div class="row">
                              <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="bonus" type="number" value="0">
                                </div>
                              </div>
                            </div>
...
$no_slip = random(10); //jFodd9UWwG  
    ...
    $tambah = mysqli_query($koneksi,"INSERT INTO gaji ( tgl_gaji,  no_slip, bulan, tahun,  id_absensi,  gaji_bersih,  gajipok, tunjangan, bonus, potongan) VALUES(
          '$now',
          '$no_slip',
          '$bulan',
          '$tahun',
