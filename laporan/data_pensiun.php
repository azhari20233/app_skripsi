...
if (isset($_POST['cetak'])) {
  ...
  $result = mysqli_query($koneksi, "SELECT * FROM t_pensiun INNER JOIN t_pegawai ON t_pensiun.nip=t_pegawai.nip WHERE t_pensiun.tgl_pensiun LIKE '%$tahun%' ORDER BY tgl_pensiun ASC");
}else{
  $result = mysqli_query($koneksi, "SELECT * FROM t_pensiun INNER JOIN t_pegawai ON t_pensiun.nip=t_pegawai.nip");
}?>
  ...
  <tbody>
    ...
    <tr>
      <td><h5>Perihal</h5></td>
      <td>:</td>
      <td><h5>Seluruh Data Pensiun</h5></td>
    </tr>
  </tbody>
</table>
  ...
  <div class="container">
  <h2 class="text-center">DAFTAR PENSIUN</h2>
